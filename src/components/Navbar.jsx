              ...
              {navItems.map((item) => (
                <Tilt key={item.name} options={{ max: 15, scale: 1.03 }}>
                  <motion.button
                    ...
                    className={`px-3 py-2 text-sm font-medium nav-item ${
          ...
          >
            <form onSubmit={handleSearch}>
              <input
                ...
                className="w-full p-2 rounded-full bg-gray-800/50 text-white border border-gray-600 focus:border-blue-500 focus:ring-blue-500"
                aria-label="Search"
              />
            </form>
...
//                     className="px-4 py-2 hover:bg-gray-700/50 cursor-pointer"
//                     onClick={() => {
//                       handleNavigation(navItems.find((item) => item.name === suggestion).path);
//                       setSearchQuery('');
//                       setIsSearchOpen(false);
//                     }}
//                   >
